...
<body>
    <div id="main-container" class="container">
        ...
        <!-- Cuerpo del body-->
        <div id="main-content" class="content container-fluid" style="overflow:scroll;">
            <div class="page-header">
                ...
                <ul id="listE">
                    <li>Facilidad de publicacion de anuncios</li>
                    <li>Restricción de acceso al sistema</li>
                    <li>Control de usuario registrados</li>
                    <li>Facilidad de acceso</li>
                </ul>
                <h2 class="welcomeS">Contactos</h2>
                <p>Leonardo Iván Hervert Morales: leohervert@gmail.com 4443305334 </p>
                <p>Francisco Javier Gómez Vázquez: pacojagova@gmail.com 4441904398</p>
